// Copied from monogame with slightly changes https://github.com/mono/MonoGame/blob/develop/MonoGame.Framework/Game.cs 
using System;
...
namespace UnknownProject.Components
{
    ...
    /// </summary>
    class MonoGameSortingFilteringCollection<T> : ICollection<T>
    {
        ...
        public MonoGameSortingFilteringCollection(
            Predicate<T> filter,
        ...
        public List<T> WithOrderAndFilter()
        {
            RebuildCache();
        ...
        {
            RebuildCache(); // badly items get filled only from building the cache - jmattheis
